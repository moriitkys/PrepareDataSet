...
class MakeDataSetRGB():
    ...
    def imgSave(self, img):
        self.n += 1
        filename1 = self.img_output_folder+"/img_" +str(self.n).zfill(4)+'.png'
    ...
    def do_augmentation(self, dataset_folder_name):
        ...
        #self.img_input_folder = self.pathc + '/' + dataset_folder_name + '/'+self.class_folder
        #self.img_output_folder = '/' + dataset_folder_name + '_aug'
        #self.imgs = glob.glob(self.img_input_folder + '/*')
